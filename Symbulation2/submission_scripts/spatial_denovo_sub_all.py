...
script_name = "/mnt/home/anyaejo/Mutualism/mutualism_model/Symbulation2/spatial_denovo"
...
#treatments= ["${PBS_ARRAYID} 0.001 0.1 0"]



header = "#!/bin/bash -login\n\n#PBS -l walltime=4:00:00\n#PBS -l nodes=1:ppn=1\n#PBS -l mem=2gb\n#PBS -N spatial_denovo\n#PBS -t 1001-1020\n\ncd /mnt/home/anyaejo/Mutualism/spatial_denovo\nmodule load GNU/5.2\n"
