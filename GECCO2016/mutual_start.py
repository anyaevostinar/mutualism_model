...
class Population:
  ...
  def makeOrg(self):
    ...
    if random.random() < starting_symbiont_proportion:
      ...
      #Symbionts starting mutualists in this treatment
      randomBitArray2[0:10]=1
...
if len(sys.argv) == 1 or sys.argv[1] == "--help":
  ...
  data_file = open("mutual_start"+str(vertical_transmission)+"_"+str(seed)+".dat", 'w')
  ...
  for i in range(num_updates):
    ...
    if i%100 == 0:
      ...
      data_file = open("mutual_start"+str(vertical_transmission)+"_"+str(seed)+".dat", 'a')
