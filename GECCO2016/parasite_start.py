...
class Population:
  ...
  def makeOrg(self):
    ...
    if random.random() < starting_symbiont_proportion:
      ...
      #Symbionts starting parasites in this treatment
      randomBitArray2[0:10]=0
...
if len(sys.argv) == 1 or sys.argv[1] == "--help":
  ...
  data_file = open("parasite_start"+str(vertical_transmission)+"_"+str(seed)+".dat", 'w')
  data_file.write("Update Donation_Avg Num_Symbionts Num_Hosts Symbiont_Bonus_Prop Host_Fitness Num_Vert_Trans Num_Hor_Trans\n")
  data_file.close()
...
#      print "Update: ", i
      ...
      data_file = open("parasite_start"+str(vertical_transmission)+"_"+str(seed)+".dat", 'a')
